...
public class TestResUAController {
    ...
    public ResponseEntity getAllObjects() {
        return ResponseEntity.ok(testResultUserAnswerService.getAllObjects());
    }
    ...
    @PutMapping("/{id}")
    public ResponseEntity editObject(@PathVariable Long id, @RequestBody TestResultUserAnswer testResultUserAnswer) {
        try {
